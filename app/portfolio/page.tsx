          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                Discover our specialized subsidiaries, each designed to address
                unique market needs with cutting-edge solutions.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                SL Tech Innovators delivers comprehensive technology services
                designed to transform business operations and drive digital
                excellence. Our team of experts provides tailored solutions that
                enable organizations to thrive in an increasingly digital
                landscape.
              </p>
              <div className="space-y-2">
            ...
            <div className="rounded-lg bg-muted p-4">
              <div className="aspect-video rounded-lg bg-gradient-to-r from-primary/20 to-primary/40 flex items-center justify-center overflow-hidden h-full">
                <img
                  src="/portfolio/Tech Innovators.jpg"
                  alt="Tech Innovators"
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="rounded-lg bg-muted p-4">
              <div className="aspect-video rounded-lg bg-gradient-to-r from-primary/20 to-primary/40 flex items-center justify-center overflow-hidden h-full">
                <img
                  src="/portfolio/Elite Events.jpg"
                  alt="Elite Events"
                  className="w-full h-full object-cover object-center"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                SL Elite Events specializes in crafting exceptional experiences
                through meticulous planning and creative execution. From
                corporate functions to personal celebrations, we transform
                visions into flawlessly executed events.
              </p>
              <div className="space-y-2">
                <h3 className="font-bold">Specializations:</h3>
                <ul className="space-y-1 text-muted-foreground">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                SL Prime Properties offers an exclusive portfolio of luxury real
                estate solutions, from residential accommodations to
                sophisticated event venues. We provide discerning clients with
                spaces that reflect elegance, comfort, and distinction.
              </p>
              <div className="space-y-2">
                <h3 className="font-bold">Specializations:</h3>
                <ul className="space-y-1 text-muted-foreground">
            ...
            <div className="rounded-lg bg-muted p-4">
              <div className="aspect-video rounded-lg bg-gradient-to-r from-primary/20 to-primary/40 flex items-center justify-center overflow-hidden h-full">
                <img
                  src="/portfolio/Prime Properties.jpg"
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="rounded-lg bg-muted p-4">
              <div className="aspect-video rounded-lg bg-gradient-to-r from-primary/20 to-primary/40 flex items-center justify-center overflow-hidden h-full">
                <img
                  src="/portfolio/Grooming Studio.jpg"
                  alt="Grooming Studio"
                  className="w-full h-full object-cover object-center"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                SL Grooming Studio elevates the traditional salon experience
                through exceptional service, master craftsmanship, and an
                atmosphere of refined luxury. We cater to clients of all genders
                who appreciate precision, style, and the finer details.
              </p>
              <div className="space-y-2">
                <h3 className="font-bold">Specializations:</h3>
                <ul className="space-y-1 text-muted-foreground">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                SL Stationery Hub provides premium writing instruments, paper
                products, and printing services that inspire creativity and
                enhance productivity. We source exceptional products and deliver
                customized solutions for individuals and organizations alike.
              </p>
              <div className="space-y-2">
                <h3 className="font-bold">Specializations:</h3>
                <ul className="space-y-1 text-muted-foreground">
            ...
            <div className="rounded-lg bg-muted p-4">
              <div className="aspect-video rounded-lg bg-gradient-to-r from-primary/20 to-primary/40 flex items-center justify-center overflow-hidden h-full">
                <img
                  src="/portfolio/Stationery Hub.jpg"
                  alt="Stationery Hub"
                  className="w-full h-full object-cover object-center"
                />
              </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="rounded-lg bg-muted p-4">
              <div className="aspect-video rounded-lg bg-gradient-to-r from-primary/20 to-primary/40 flex items-center justify-center overflow-hidden h-full">
                <img
                  src="/portfolio/Liquor & Market.jpg"
                  alt="Liquor & Market"
                  className="w-full h-full object-cover object-center"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground">
                Premium Convenience at Your Fingertips
              </p>
              <p className="text-muted-foreground">
                SL Liquor & Market offers a curated selection of alcoholic
                beverages, gourmet groceries, and everyday essentials. We
                provide discerning clients with convenience and quality.
              </p>
              <div className="space-y-2">
                <h3 className="font-bold">Specializations:</h3>
                <ul className="space-y-1 text-muted-foreground">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] md:text-xl">
                ...
                transformation, a couple planning your perfect wedding, a
                property investor, someone looking for premium grooming
                services, or a business needing quality stationery solutions—SL
                Group invites you to experience our difference.
              </p>
            </div>
            <div>
              <Link href="/contact">
